...
class MigrationHelper
{
    ...
    public static function getMigrationTypeSettings($type,ContainerInterface $container)
    {
     ...
     * @throws \Exception
     */
    public static function getConnection($type, ContainerInterface $container, $connName = null)
    {
        ...
        throw new \Exception(sprintf('Cannot find connection for migration type: ',$type));
    }
